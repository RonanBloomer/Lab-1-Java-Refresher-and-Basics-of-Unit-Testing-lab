...
public class SimpleBankingAppTest {
	...
	// Setup phase
			...
			double withdrawalAmount = -13.13;
			
			System.out.println("Testing what values is stored in the account initially before withdrawal = " + mainApp.getBalance("5495-6789"));
			...
			//assert 5==2;
			System.out.println("testWihtdrawals: TC1 passed.");
			
			// tear-down: put the system state back in where it was
			System.out.println("Testing what is stored in the account before tear-down = " + mainApp.getBalance("5495-6789"));
			mainApp.addTransaction("5495-6789", -withdrawalAmount);
			System.out.println("Testing what is stored in the account after tear-down = " + mainApp.getBalance("5495-6789"));
	}
